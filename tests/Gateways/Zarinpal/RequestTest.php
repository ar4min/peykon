...
namespace Ar4min\PayKon\Tests\Gateways\Zarinpal;

use Ar4min\PayKon\Exceptions\GatewayClientException;
use Ar4min\PayKon\Exceptions\GatewayServerException;
use Ar4min\PayKon\Factory;
use Ar4min\PayKon\Gateways\Zarinpal\Gateway;
use Ar4min\PayKon\Gateways\Zarinpal\RequestedPayment;
...
final class RequestTest extends TestCase
{
    ...
    /**
     * @test
     * @dataProvider \Ar4min\PayKon\Tests\Gateways\Zarinpal\Provider::endpointProvider()
     */
    ...
    /**
     * @test
     * @dataProvider \Ar4min\PayKon\Tests\Gateways\Zarinpal\Provider::clientErrorProvider()
     */
    ...
    /**
     * @test
     * @dataProvider \Ar4min\PayKon\Tests\Gateways\Zarinpal\Provider::tomanBasedAmountProvider()
     */
